...
SELECT
    t.treatment_type,
    COUNT(*) AS total_treatments,
    ROUND(SUM(t.cost) / COUNT(*), 2) AS avg_cost,
...
-- Result:
-- treatment_type | total_treatments | avg_cost | total_revenue | revenue_percentage
-- Chemotherapy   | 49               | 2629.71  | 128855.68     | 23.4
-- MRI            | 36               | 3224.95  | 116098.16     | 21.1
-- X-Ray          | 41               | 2698.87  | 110653.67     | 20.1
-- Physiotherapy  | 36               | 2761.61  | 99418.10      | 18.0
-- ECG            | 38               | 2532.22  | 96224.24      | 17.5